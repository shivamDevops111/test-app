...
const Footer = () => {
    return (
        <footer class="w-full bg-dark-navy ">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    ...
                    <div class="lg:mx-auto text-left ">
                        <h4 class="text-lg text-gray-100 font-medium mb-7">Pagedone</h4>
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-100">Home</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">About</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Pricing</a></li>
                            <li><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Features</a></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div class="lg:mx-auto text-left ">
                        <h4 class="text-lg text-gray-100 font-medium mb-7">Products</h4>
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-100">Figma UI System</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Icons Assets</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Responsive Blocks</a></li>
                            <li><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Components Library</a></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div class="lg:mx-auto text-left">
                        <h4 class="text-lg text-gray-100 font-medium mb-7">Resources</h4>
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-100">FAQs</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Quick Start</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Documentation</a></li>
                            <li><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">User Guide</a></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div class="lg:mx-auto text-left">
                        <h4 class="text-lg text-gray-100 font-medium mb-7">Blogs</h4>
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-100">News</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Tips & Tricks</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">New Updates</a></li>
                            <li><a href="javascript:;" class=" text-gray-400 hover:text-gray-100">Events</a></li>
                        </ul>
                    </div>
                </div>
                {/* <!--Grid--> */}
