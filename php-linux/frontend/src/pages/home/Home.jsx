                    ...
                    <div className=' w-full my-12 '>
                        <div >
                            ...
                            <div className='flex items-center mt-6 gap-6'>
                                <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.8 }}>
                                ...
                                <motion.div to initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.8 }}>
                            ...
                            <div className="bg-gray-750 bg-dark-navy rounded-xl p-6 border min-w-[500px] border-gray-600 hover:border-purple-500 transition-colors duration-200">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm">Prof. Nuksaan</p>
                                    </div>
                                    <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
                                        Live
                                    </span>
                            ...
                            <div className="bg-gray-750 bg-dark-navy rounded-xl p-6 border min-w-[500px] border-gray-600 hover:border-purple-500 transition-colors duration-200">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm">Dr. Mistry</p>
                                    </div>
